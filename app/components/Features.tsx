...
export default function Features({ uiLang }: FeaturesProps) {
  const t = translations[uiLang].features;

  return (
    <section id="features" className="relative py-20 sm:py-28 mesh-gradient">
      <div className="relative z-10 max-w-6xl mx-auto px-5 sm:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {features.map((f, i) => {
            const item = t.items[i] || { title: "", desc: "" };
            return (
              <div
                key={i}
